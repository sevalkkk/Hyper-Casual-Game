...
public class BridgeSpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hiddenPlatform.transform.position = startReference.transform.position + (direction * distance / 2) + (new Vector3(0, -direction.z+20, direction.y) * hiddenPlatform.size.y / 2);
